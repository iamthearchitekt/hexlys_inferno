...
code = code.replace(/            // Pulsing orange-red glow overlay using 'lighter' composite \(sin wave 0\.\.1\)/, restored + '\n            // Pulsing orange-red glow overlay using \'lighter\' composite (sin wave 0..1)');
